    ...
    getBeers: function () {
      return [
        ...
        },
        {
          name: 'Chouffe',
          note: 4,
          description: 'La Chouffe est une bière blonde belge. Elle est produite par la brasserie d\'Achouffe, dans le village du même nom, en province de Luxembourg. Elle fait partie des « blondes des Ardennes ».',
          image: 'chouffe.jpg'
        },
        {
        ...
        },
        {
          ...
          note: 4,
          description: 'La St Feuillien est une bière belge d\'Abbaye reconnue produite au Rœulx (province de Hainaut) dans la brasserie St-Feuillien appelée aussi brasserie Friart.',
          image: 'saint-feuillien.jpg'
        }
      ];
    }
  }
